...
import { X, Server, Database, HardDrive, Wifi, Save, Plus } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-700">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">
              Configurez les ressources et variables d&apos;environnement
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Content */}
        <div data-scrollable className="flex-1 p-6 space-y-6 overflow-y-auto">
